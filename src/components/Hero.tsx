          ...
          <div className="text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center group"
              >
                File a Complaint
