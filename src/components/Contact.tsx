  ...
  return (
    <section id="contact" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="complaint-form" className="mt-20 bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-8 text-white text-center">
          ...
          <button 
            ...
            className="bg-white text-orange-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-colors duration-300 transform hover:scale-105"
          >
